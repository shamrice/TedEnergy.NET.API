...
namespace DataExporter
{
    public class DataExporterServices
    {
        ...
        public string DebugTests()
        {
            ...
            foreach (DataObject obj in webApi.GetDataObjectCache())
            {
                DashData dashData;
                Rate rate;
                ...
                if (DataObjectTypeCaster<DashData>.TryParse(obj, out dashData))
                {
                ...
                if (DataObjectTypeCaster<Rate>.TryParse(obj, out rate))
                {
                ...
                if (DataObjectTypeCaster<SystemOverview>.TryParse(obj, out sysOverview))
                {
                ...
                if (DataObjectTypeCaster<Stats>.TryParse(obj, out stats))
                {
                    result += "Stats:\n";
